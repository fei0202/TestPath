...
public class AutoB3 extends SequentialCommandGroup {
    private final Swerve swerve;
    private final Intake intake;
    private final Elevator elevator;
    private final Arm arm;

    public AutoB3(Swerve swerve, Intake intake, Elevator elevator, Arm arm) {
        this.arm = arm;
        ...
        addCommands(
                ...
                new RunCommand(() -> arm.setArmSpeed(CombinedControlConstants.ARM_SPEED), arm)
                        .withTimeout(0.5),
                new RunCommand(() -> elevator.setDesiredHeight(ElevatorConstants.ELEVATOR_L3_HEIGHT), arm)
                        .withTimeout(2),
                new RunCommand(() -> arm.setArmSpeed(CombinedControlConstants.ARM_SPEED), arm)
                        .withTimeout(0.5),
                new RunCommand(() -> intake.setIntakeSpeed(CombinedControlConstants.INTAKING_SPEED), intake)
                        .withTimeout(1),
